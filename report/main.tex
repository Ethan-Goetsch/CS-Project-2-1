...
\begin{enumerate}
    \item Is it possible to use machine learning solutions to train an agent in Unity?
    \item If so, what is the most efficient reward structure to achieve this goal? 
\end{enumerate}
